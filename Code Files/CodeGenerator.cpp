...
string generate_parallel_source(string width, string height, string k) {
...
int main(int argc, char* argv[]) {
    cout << "Enter sequential source file name: ";
    string filename;
    cin >> filename;

    ifstream file(filename);
    if (!file) {
        cerr << "[Generator] Error: Cannot open file " << filename << endl;
        return 1;
    }
    ...
    string width = extract_value(content, "width");
    string height = extract_value(content, "height");
    ...
    cout << "------------------------------------------" << endl;
    cout << "[Code Generator] Analyzing " << filename << "..." << endl;
    cout << "  > Found configuration: Width=" << width << ", Height=" << height << ", K=" << k << endl;
    cout << "------------------------------------------" << endl;

    string source = generate_parallel_source(width, height, k);
    ofstream out("parallel_generated.cpp");
    out << source;
    out.close();

    cout << "[Code Generator] Successfully created parallel_generated.cpp" << endl;
    return 0;
}
